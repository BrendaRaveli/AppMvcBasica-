    ...
    public partial class TabelasSistema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    //PrimaryKey, Uma chave primária é um atributo ou conjunto de atributos que identifica unicamente um registro na tabela e que por isso não pode ser repetido,
                    //pois caso contrário não teria como diferenciar um registro de outro quando fossemos consultá-los.
                    //ForeignKey (FK), ou ainda chave externa é a chave que permite a referência a registros oriundos de outras tabelas...
